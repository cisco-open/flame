...
// Accepts only nested slice of Optimizer (e.g. [][]Optimizer), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseOptimizerRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aOptimizer, ok := obj.(Optimizer)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertOptimizerRequired(aOptimizer)
	})
}
