...
type EventRouteClient interface {
	...
	GetEvent(ctx context.Context, in *AgentInfo, opts ...grpc.CallOption) (EventRoute_GetEventClient, error)
}
...
func (c *eventRouteClient) GetEvent(ctx context.Context, in *AgentInfo, opts ...grpc.CallOption) (EventRoute_GetEventClient, error) {
...
type EventRouteServer interface {
	// This implements a server side streaming RPC
	GetEvent(*AgentInfo, EventRoute_GetEventServer) error
...
func (UnimplementedEventRouteServer) GetEvent(*AgentInfo, EventRoute_GetEventServer) error {
