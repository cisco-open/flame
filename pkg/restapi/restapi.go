...
var URI = map[string]string{
	...
	GetComputeStatusEndpoint:    "/computes/{{.computeId}}/apikey/{{.apiKey}}",
	UpdateComputeEndpoint:       "/computes/{{.computeId}}/apikey/{{.apiKey}}",
	DeleteComputeEndpoint:       "/computes/{{.computeId}}/apikey/{{.apiKey}}",
	GetComputeConfigEndpoint:    "/computes/{{.computeId}}/apikey/{{.apiKey}}/config",
	GetDeploymentsEndpoint:      "/computes/{{.computeId}}/apikey/{{.apiKey}}/deployments",
	GetDeploymentConfigEndpoint: "/computes/{{.computeId}}/apikey/{{.apiKey}}/deployments/{{.jobId}}/config",
	PutDeploymentStatusEndpoint: "/computes/{{.computeId}}/apikey/{{.apiKey}}/deployments/{{.jobId}}/status",
	GetDeploymentStatusEndpoint: "/computes/{{.computeId}}/apikey/{{.apiKey}}/deployments/{{.jobId}}/status",
}
