...
func (c *container) UpdateDesignSchemas() *cobra.Command {
	var command = &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return c.service.Update(&models.SchemaParams{
	...
	command.PersistentFlags().StringP("path", "p", "", "Path to schema json file")
	command.MarkPersistentFlagRequired("path")
