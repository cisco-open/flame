...
func (s *notificationServer) SetupAgentStream(in *pbNotification.AgentInfo,
	stream pbNotification.NotificationStreamingStore_SetupAgentStreamServer) error {
...
func (s *notificationServer) addNewClient(in *pbNotification.AgentInfo,
	stream *pbNotification.NotificationStreamingStore_SetupAgentStreamServer) {
	uuid := in.GetUuid()
...
func (s *notificationServer) pushNotification(clientID string,
	notifyType pbNotification.StreamResponse_ResponseType, in interface{}) error {
...
func (s *notificationServer) pushNotifications(clients []string,
	notifyType pbNotification.StreamResponse_ResponseType, in interface{}) map[string]interface{} {
...
// broadcastNotification broadcasts notification to all the connected clients
func (s *notificationServer) broadcastNotification(notifyType pbNotification.StreamResponse_ResponseType,
