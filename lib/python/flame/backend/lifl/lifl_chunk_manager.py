...
class LIFLChunkThread(Thread):
    """Shared Memory ChunkThread class."""
    ...
    def __init__(
        ...
        self.queue = Queue()
        self.chunk_store = LIFLChunkStore()
        self._done = False
...
class LIFLChunkManager(object):
    """Shared Memory ChunkStore class."""

    def __init__(self, backend):
        """Initialize an instance."""
        self._backend = backend
        self._chunk_threads: dict[str, LIFLChunkThread] = {}
    ...
    def handle(self, msg: msg_pb2.Data, channel: Channel) -> None:
        ...
        if msg.end_id not in self._chunk_threads:
            ...
            chunk_thd = LIFLChunkThread(kwargs=kwargs, daemon=True)
