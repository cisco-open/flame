...
cd aggregator/ && python pytorch/main.py fedbuff_config_large_oracular_trackFail.json > agg_fedbuff_config_dir100_num100_fail_oracular_aware_c20_k10_n100_1apr24.txt &
sleep 30
# Run Bash command as background process and wait for 90 minutes
cd trainer/config_dir100_num100_traceFailure_1.5h/ && bash exec_100_trainers.sh > logs_trainer_config_dir100_num100_fedbuff_fail_oracular_aware_c20_k10_n100_1apr24.txt &
sleep "$duration"
