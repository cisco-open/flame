...
cd aggregator/ && python pytorch/main.py fedbuff_config_test_expt_heartbeat_1s_trackFail.json > agg_fedbuff_config_dir100_num100_fail_heartbeat_1s_aware_c6_k4_n10_1apr24.txt &
sleep 30
# Run Bash command as background process and wait for 90 minutes
cd trainer/config_dir100_num100_traceFailure_1.5h/ && bash exec_10_trainers.sh > logs_trainer_config_dir100_num100_fedbuff_fail_heartbeat_1s_aware_1apr24.txt &
sleep "$duration"
